...
import { fishProducts } from "../data/products";
...
const Fish = () => (
  <div>
    ...
    <div className="relative h-72 md:h-96 flex items-end overflow-hidden">
      <img
        src="https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=1600&q=80"
        alt="Fresh Fish"
      ...
      <div className="relative z-10 container-max px-4 sm:px-6 lg:px-8 pb-10 w-full">
        ...
        <span className="inline-block mb-2 px-3 py-1 bg-blue-600 text-white text-xs font-semibold rounded-full">
          Market Fresh
        </span>
        <h1 className="font-display text-3xl md:text-5xl font-black text-white">
          Fresh Fish — Straight from the Morning Market
        </h1>
        <p className="text-white/70 mt-2 text-sm md:text-base max-w-lg">
          Cleaned, scaled, and boneless-ready. We source daily from the local fish market.
        </p>
      </div>
    </div>
    ...
    <div className="section-padding bg-gray-50">
      <div className="container-max">
        <SectionTitle
          ...
          subtitle="Apollo boneless fish available in curry cut or crispy fry cut — both freshly prepared."
          center={false}
        />
